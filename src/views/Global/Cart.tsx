  ...
  const handelGoodsReception = (event: FormEvent) => {
    ...
    cart.map(async (item) => {
      try {
        ...
        setOpenSnackbar({
          open: true,
          alert: `Nie powiodło się przyjęcie produktu na stan, spróbuj ponownie.`,
          variant: "error",
        });
      } finally {
        ...
        setOpenSnackbar({
          open: true,
          alert: `Przyjęto na stan ${item.name} - ${item.amount}`,
          variant: "success",
        });
      }
    });
  ...
  const handelGoodsIssue = (event: FormEvent) => {
    ...
    cart.map(async (item) => {
      try {
        ...
        setOpenSnackbar({
          open: true,
          alert: `Nie powiodło się wydanie produktu, spróbuj ponownie.`,
          variant: "error",
        });
      } finally {
        dispatch(setStatus("idle"));
        setOpenSnackbar({
          open: true,
          alert: `Wydano ${item.name} - ${item.amount}`,
          variant: "success",
        });
      }
    });
