...
export const SupplyList = () => {
  ...
  const [supplyList, setSupplyList] = useState<OrderViewEntity[]>([]);
  ...
  async function getItems() {
    const res = await fetch("http://localhost:3001/supply", { method: "GET" });
    setSupplyList(await res.json());
  }
  ...
  const columns: GridColDef[] = [
    ...
    { field: "amount", headerName: "Ilość zam.", flex: 0.5, type: "number" },
    {
      field: "data",
      headerName: "Data zam.",
      flex: 0.8,
